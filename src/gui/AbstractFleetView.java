...
public abstract class AbstractFleetView extends JPanel implements AbstractFleetModel.ModelUpdateListener
{
   private static final String[] ALPHA_SCALE = {"A", "B", "C", "D", "E", "F", "G", "H", "I", "J"};
   private static final String MY_TITLE = "My Fleet";
   ...
   protected static final String ENEMY_TITLE = "Enemy Fleet";
   ...
   public AbstractFleetView(final GridButtonHandler gridButtonHandler)
   {
